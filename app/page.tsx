...
export default function Home() {
  const grid_columns = [1, 2, 3,4,5,6,7];
        ...
        <div className="parent">
          {grid_rows.map(r=>
            ...
            {grid_columns.map(n=><svg key={"r"+r+n} width="172" height="100" viewBox="0 0 172 99" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1.99648 48.2609L84.005 1.39891L169.459 49.2532L84.9971 96.9002L1.99648 48.2609Z" fill="#9EDA82" stroke="#B0F191" stroke-width="2" />
            </svg>)}
          </div>
            )}
        </div>
