  ...
  return (
    <div dir='rtl'>
      ...
      <div id="welcome-modal" className="modal">
        ...
        <svg id='flower'width="110" height="248" viewBox="0 0 110 248" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_506_381)">
            <path d="M87.981 162.044C88.6557 167.876 72.9538 174.484 63.3309 175.597C53.708 176.711 45.3602 172.885 44.6855 167.053C44.0108 161.221 51.2648 155.591 60.8877 154.477C70.5106 153.364 87.3064 156.212 87.981 162.044Z" fill="#376720"/>
            <path d="M14.8215 132.394C10.1661 135.971 16.3581 151.841 22.2602 159.523C28.1622 167.204 36.7208 170.532 41.3762 166.955C46.0317 163.378 45.0211 154.251 39.119 146.569C33.2169 138.888 19.477 128.817 14.8215 132.394Z" fill="#376720"/>
            <path d="M23.3298 51.1338C30.6803 56.9929 52.7939 68.3276 65.835 88.5255C82.1363 113.773 59.7628 123.68 47.9381 153.082C42.0851 167.635 46.1024 180.165 54.3708 191.414C65.0579 205.954 79.4091 220.127 73.6323 237.223C68.504 252.399 55.3778 269.529 31.3195 278.68" stroke="#376720" stroke-width="7.6701"/>
            <circle cx="43.6284" cy="41.0712" r="36.8362" transform="rotate(-35.0679 43.6284 41.0712)" fill="#EDD453"/>
            <path d="M49.2138 33.6378V45.5832H44.5451V37.8235H38.2665C37.1718 37.8235 36.7532 38.3387 36.7532 39.5944V51.3467H31.7625V38.3387C31.7625 35.1833 33.1793 33.6378 36.0449 33.6378H49.2138ZM38.3953 51.3467V39.4012H43.064V47.1609H49.3426C50.4374 47.1609 50.8559 46.6458 50.8559 45.3901V33.6378H55.8466V46.6458C55.8466 49.8012 54.4299 51.3467 51.5643 51.3467H38.3953Z" fill="#BFAB42"/>
            </g>
            <defs>
            <clipPath id="clip0_506_381">
            <rect width="109.938" height="248" fill="white"/>
            </clipPath>
            </defs>
            </svg>
